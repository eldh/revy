  ...
  <ComponentsCard title="Typography">
    <Box w=`full>
      <>
        ...
        <Text.Paragraph m={`margin(`noSpace)} size=5 weight=`extraBold>
          "Extra bold and very big"
        </Text.Paragraph>
        <Text.Paragraph m={`margin(`noSpace)} size=4 weight=`bold>
          "Bold and big"
        </Text.Paragraph>
        <Text.Paragraph quiet=true m={`margin(`noSpace)} size=3 weight=`light>
          "Light and tall, like a basketball player"
        </Text.Paragraph>
        <Text.Paragraph m={`margin(`noSpace)} size=2 weight=`extraLight>
          "Supermodel style"
        </Text.Paragraph>
        ...
        <Text.Paragraph quiet=true m={`margin(`noSpace)} size=(-2)>
