...
function r(a) {
  ...
  if (Array.isArray(b)) throw m(103);
...
function x(a, b) {
  ...
  if (a) return null;
  if (c && 'function' !== typeof c) throw m(231, b, typeof c);
  return c;
}
function y(a, b, c) {
  if ((b = x(a, c.dispatchConfig.phasedRegistrationNames[b])))
    (c._dispatchListeners = v(c._dispatchListeners, b)),
      (c._dispatchInstances = v(c._dispatchInstances, a));
}
function aa(a) {
...
function z(a) {
  if (a && a.dispatchConfig.registrationName) {
    ...
    if (b && a && a.dispatchConfig.registrationName) {
      ...
      c &&
        ((a._dispatchListeners = v(a._dispatchListeners, c)),
        (a._dispatchInstances = v(a._dispatchInstances, b)));
    }
  }
}
function B() {
...
function da(a) {
  if (!(a instanceof this)) throw m(279);
  a.destructor();
...
var S = {
  recordTouchTrack: function(a, b) {
    if (H(a)) b.changedTouches.forEach(fa);
    else if (G(a))
      b.changedTouches.forEach(ea),
        (N.numberActiveTouches = b.touches.length),
        1 === N.numberActiveTouches &&
          (N.indexOfSingleActiveTouch = b.touches[0].identifier);
    else if (
      I(a) &&
      (b.changedTouches.forEach(ha),
      (N.numberActiveTouches = b.touches.length),
      1 === N.numberActiveTouches)
    )
...
function W(a, b) {
  ...
  if (null !== X.GlobalResponderHandler)
    X.GlobalResponderHandler.onChange(c, a, b);
}
var Y = {
    ...
    responderStart: { registrationName: 'onResponderStart', dependencies: J },
    responderMove: { registrationName: 'onResponderMove', dependencies: K },
    responderEnd: { registrationName: 'onResponderEnd', dependencies: L },
    responderRelease: {
    ...
    extractEvents: function(a, b, c, f) {
      ...
      if (
        ...
        var e = G(a)
          ...
          : H(a)
          ? Y.moveShouldSetResponder
          : 'selectionchange' === a
          ? Y.selectionChangeShouldSetResponder
          : Y.scrollShouldSetResponder;
        if (U)
          b: {
            var d = U;
            for (var g = 0, h = d; h; h = t(h)) g++;
            h = 0;
            for (var A = b; A; A = t(A)) h++;
            for (; 0 < g - h; ) (d = t(d)), g--;
            for (; 0 < h - g; ) (b = t(b)), h--;
            for (; g--; ) {
        ...
        e && e !== U
          ? ((d = void 0),
            (b = F.getPooled(Y.responderGrant, e, c, f)),
            (b.touchHistory = S.touchHistory),
            w(b, z),
            (g = !0 === r(b)),
            U
              ? ((h = F.getPooled(Y.responderTerminationRequest, U, c, f)),
                (h.touchHistory = S.touchHistory),
                w(h, z),
                (A = !h._dispatchListeners || r(h)),
                h.isPersistent() || h.constructor.release(h),
                A
                  ? ((h = F.getPooled(Y.responderTerminate, U, c, f)),
                    (h.touchHistory = S.touchHistory),
                    w(h, z),
                    (d = T(d, [b, h])),
                    W(e, g))
                  : ((e = F.getPooled(Y.responderReject, e, c, f)),
      ...
      if ((a = d ? Y.responderTerminate : a ? Y.responderRelease : null))
        (c = F.getPooled(a, U, c, f)),
          (c.touchHistory = S.touchHistory),
          w(c, z),
          (e = T(e, c)),
          W(null);
      return e;
