...
var t = 'function' === typeof Symbol && Symbol.for,
  ...
  ka = t ? Symbol.for('react.event_component') : 60117,
  la = t ? Symbol.for('react.event_target') : 60118;
...
var Va = (function() {
  function a(b, d) {
    ...
    p.isValidElement(b)
      ? b.type !== v
        ? (b = [b])
        : ((b = b.props.children), (b = p.isValidElement(b) ? [b] : Z(b)))
      : (b = Z(b));
    b = {
      type: null,
  ...
  a.prototype.render = function(a, d, c) {
    ...
    if ('object' === typeof b && null !== b)
      switch (b.$$typeof) {
        ...
        case ia:
          return (
            (a = [p.createElement(b.type, l({ ref: a.ref }, a.props))]),
            this.stack.push({
              type: null,
              domNamespace: c,
              children: a,
  ...
  a.prototype.renderDOM = function(a, d, c) {
    ...
    if ((h = e)) {
      if (Ha[b] && (null != h.children || null != h.dangerouslySetInnerHTML))
        throw r(137, b, '');
