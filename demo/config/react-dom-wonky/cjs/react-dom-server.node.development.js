      ...
      if (!validatedTagCache.hasOwnProperty(tag)) {
        (function() {
          if (!VALID_TAG_REGEX.test(tag)) {
            {
              throw ReactError('Invalid tag: ' + tag);
            }
          }
        })();
            ...
            switch (elementType.$$typeof) {
              ...
              case REACT_MEMO_TYPE: {
                ...
                var _nextChildren5 = [
                  React.createElement(
                    elementType.type,
                    _assign({ ref: _element.ref }, _element.props)
                  ),
                ];
                var _frame5 = {
                  type: null,
              ...
              case REACT_EVENT_TARGET_TYPE: {
                if (enableEventAPI) {
                  if (
                    ...
                    var bottom = props.bottom || 0;
                    var left = props.left || 0;
                    var right = props.right || 0;
                    var top = props.top || 0;
                    ...
                    var topString = top ? '-' + top + 'px' : '0px';
                    var leftString = left ? '-' + left + 'px' : '0px';
                    var rightString = right ? '-' + right + 'px' : '0x';
                    var bottomString = bottom ? '-' + bottom + 'px' : '0px';
                  ...
                  var _nextChildren8 = toArray(nextChild.props.children);
                  var _frame8 = {
                    type: null,
                    domNamespace: parentNamespace,
