...
if (process.env.NODE_ENV !== 'production') {
  (function() {
    ...
    var ReactActingRendererSigil$1 = _ReactDOM$__SECRET_IN$1[12];

    var batchedUpdates = ReactDOM.unstable_batchedUpdates;

    var ReactCurrentActingRendererSigil =
      ReactSharedInternals.ReactCurrentActingRendererSigil;
    ...
    function act(callback) {
      ...
      var previousActingUpdatesSigil = void 0;
      actingUpdatesScopeDepth++;
      {
        previousActingUpdatesSigil = ReactCurrentActingRendererSigil.current;
        ReactCurrentActingRendererSigil.current = ReactActingRendererSigil$1;
      }
    ...
    var ReactActingRendererSigil = _ReactDOM$__SECRET_IN[12];
