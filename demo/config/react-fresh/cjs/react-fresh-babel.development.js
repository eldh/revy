 ...
 * react-fresh-babel.development.js
 *
...
if (process.env.NODE_ENV !== 'production') {
  (function() {
      ...
      function findInnerComponents(inferredName, path, callback) {
        ...
        switch (node.type) {
          ...
          case 'CallExpression': {
            ...
            switch (calleePath.node.type) {
              ...
              case 'Identifier': {
                ...
                var foundInside = findInnerComponents(
                  innerName,
                  firstArgPath,
                  callback
                );
          ...
          case 'VariableDeclarator': {
            ...
            var _foundInside = findInnerComponents(
              inferredName,
              initPath,
              callback
            );
      ...
      return {
        visitor: {
          ExportDefaultDeclaration: function(path) {
            ...
            findInnerComponents(inferredName, declPath, function(
              persistentID,
              targetExpr,
              targetPath
            ) {
          ...
          FunctionDeclaration: {
            enter: function(path) {
              ...
              // function Named() {}
              findInnerComponents(inferredName, path, function(
                persistentID,
                targetExpr
              ) {
                var handle = createRegistration(programPath, persistentID);
    ...
    var ReactFreshBabelPlugin$2 =
      (ReactFreshBabelPlugin$1 && ReactFreshBabelPlugin) ||
      ReactFreshBabelPlugin$1;
